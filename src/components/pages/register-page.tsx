  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ backgroundColor: "var(--bg-primary)" }}>
      <div className="w-full max-w-[600px]">
        ...
        <h2 className="text-[31px] font-extrabold mb-2 leading-tight" style={{ color: "var(--fg)" }}>
          {lang === "ru" ? "Создайте свой аккаунт" : "Create your account"}
        </h2>
        <p className="text-[15px] mb-8" style={{ color: "var(--muted)" }}>
          {lang === "ru"
            ? "Присоединяйтесь к Forhan прямо сейчас!"
            : "Join Forhan right now!"}
        </p>
